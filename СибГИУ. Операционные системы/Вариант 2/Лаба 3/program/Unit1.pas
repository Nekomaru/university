...
begin
 //очищаем переменные хранящие номер последнего блока устройства ввода/вывода
  ...
  begin
    ...
    //генерируем случайно число, которое будет записывать в устройство
    LastRecordedValue := Random(100);
    //выбираем случайно блок, в который будем писать значение
...
begin
  ...
  begin
      ...
      begin
        ...
        Form1.WriteToLog('Процесс ' + ProcessContext^.Name + ' помещен в очередь готовых');
